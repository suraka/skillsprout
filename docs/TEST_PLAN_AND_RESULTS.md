...
Implementation adds `/learning/number-garden` as a guest-only draft. Version 8 retains the number-sense lessons, approved MATH-02 prompts, and user-reviewed MATH-03 and initial MATH-04 previews. It adds a ten-part visual connecting 5/10, 0.5, and 50%. These new decimal/percent prompts remain draft pending review; MATH-04 is still partial. No database, feature API, Firebase, cookie, localStorage or sessionStorage writes are added.
...
The user approved MATH-02 and reports reviewing MATH-03 and initial MATH-04 prompts. Version 8 MATH-04 decimal/percent prompts remain draft until reviewed. This repository does not contain formal review records. EDU-M2 is PARTIAL; this activity is not the complete sequence required by the blueprint. No proficiency claim or migration was made.
...
Verified version 8 MATH-04 decimal/percent extension: results will be recorded after GitHub CI completes. The ten equal cells model five tenths; the number line marks 0.5 midway between zero and one; a second prompt connects five of ten parts to 50%.
