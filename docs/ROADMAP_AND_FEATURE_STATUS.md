...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden's three MATH-01 lessons and v2 prompts are user-reported reviewed; MATH-02 compose/decompose prompts were reviewed and approved by the user. Version 6 adds draft MATH-03 equal groups, arrays, and equal sharing with deterministic retry; no saved evidence or backend calls. | Review the new MATH-03 prompts; build MATH-04…06 as separate draft slices. Formal review records are not attached. |
...
5. **EDU-M2 mathematics (PARTIAL; draft only):** Number Garden's three MATH-01 lessons cover count, zero/order and comparison. Optional MATH-02 practice joins and splits groups and adds/takes one; the user approved its prompts. Version 6 adds draft MATH-03 equal groups, arrays, and equal sharing; MATH-04…06 remain unbuilt. Review the new MATH-03 prompts before approval. Keep the whole activity in draft.
