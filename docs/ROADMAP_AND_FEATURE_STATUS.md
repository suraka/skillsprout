...
| EDU-M2 / MATH-01…06 | PARTIAL | Draft Number Garden now covers one-to-one counting, cardinality, zero, number order, quantity comparison, add-one/take-one and deterministic retry; no saved evidence or backend calls. | Qualified review, selected locale, audio/narration decision, manual accessibility/device/family checks and the remaining number outcomes are still required. |
