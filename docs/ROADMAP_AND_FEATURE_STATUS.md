...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden's three MATH-01 lessons and v2 prompts are user-reported reviewed; MATH-02 compose/decompose prompts were reviewed and approved by the user. Version 7 includes draft MATH-03 equal groups/arrays/sharing and a small MATH-04 place-value/fractions preview, with deterministic retry and no saved evidence or backend calls. | Review the new MATH-03 and MATH-04 prompts; continue MATH-04 rational-number coverage, then build MATH-05…06 as separate draft slices. Formal review records are not attached. |
...
5. **EDU-M2 mathematics (PARTIAL; draft only):** Number Garden's three MATH-01 lessons cover count, zero/order and comparison. Optional MATH-02 practice joins and splits groups and adds/takes one; the user approved its prompts. Version 6 added draft MATH-03 equal groups, arrays, and equal sharing. Version 7 adds a small MATH-04 preview for tens/ones and fractions as equal parts; decimals, percent, and remaining MATH-04 outcomes are not implemented. Review the new MATH-03/MATH-04 prompts before approval. MATH-05…06 remain unbuilt. Keep the whole activity in draft.
...
- [ ] Review the new MATH-03 and MATH-04 prompts; complete the remaining MATH-04 objectives and build MATH-05…06 as separate tested slices.
...
Continue by reading this checklist, MASTER_BLUEPRINT.md, FOUNDATIONAL_CURRICULUM.md, EARLY_MATH_DRAFT.md and TEST_PLAN_AND_RESULTS.md. Number Garden's original v2 content is reported reviewed by the product owner; new math content requires review. Other early-years and literacy slices still have their own review gates. Next math work is review of the new MATH-03 and MATH-04 prompts, then complete the remaining MATH-04 objectives and build MATH-05…06 as separate tested draft slices. Existing lesson evidence remains untouched; no migration was run.
