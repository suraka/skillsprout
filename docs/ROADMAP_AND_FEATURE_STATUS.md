...
Updated 2026-09-24. Authority: attached SkillSprout-2.3.md, preserved at MASTER_BLUEPRINT.md.
...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden v20 uses the `en-US` locale, U.S. dollar/cents examples, and an inches-based illustrated ruler, alongside quarter-turn orientation, perimeter, elapsed whole-hour time, equal-unit mass, and draft chance, equivalent-ratio, and function-rule previews. The user reports reviewing the source prompts for money and further MATH-05 lessons. No saved learner evidence or backend calls. | The v20 U.S. locale wording/rendering and formal subject/accessibility/device/family review records need review; broader MATH-05 geometry/measurement and MATH-06 statistics/probability/ratio/algebra outcomes remain. |
...
- [x] Implement the user-reported reviewed-source MATH-05 money lesson in U.S. dollars and cents: a $1 bill equals 100 cents, and a $1 bill plus a 25-cent quarter equals $1.25. Use integer cents; no cash handling, purchase, or exchange-rate claims. Official references: [U.S. Mint Coin Classroom](https://kids.usmint.gov/about-the-mint/dollar) and [U.S. Mint Circulating Coins](https://www.usmint.gov/learn/coins-and-medals/circulating-coins). Version 20 replaces the earlier locale sample.
...
Continue by reading this checklist, MASTER_BLUEPRINT.md, FOUNDATIONAL_CURRICULUM.md, EARLY_MATH_DRAFT.md and TEST_PLAN_AND_RESULTS.md. The user reports reviewing real-currency and further MATH-05 prompts; v20 localizes them to U.S. dollars/cents and inches. MATH-06 has small data, pattern, chance, ratio and algebra samples. New v20 wording/rendering and expert/accessibility/device/family reviews still need evidence. Existing lesson evidence remains untouched; no migration was run.
