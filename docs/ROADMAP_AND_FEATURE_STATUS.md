...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden's three MATH-01 lessons and v2 prompts are user-reported reviewed; MATH-02 compose/decompose prompts were reviewed and approved by the user. Version 10 includes user-reviewed MATH-03 and MATH-04 prompts, plus an initial draft MATH-05 2D-shape and screen-length preview with deterministic retry; no saved evidence or backend calls. | Review the new MATH-05 prompts; extend 3D geometry and mass/volume/time/money measurement, then build MATH-06. Formal review records are not attached. |
