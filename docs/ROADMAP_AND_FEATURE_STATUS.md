...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden's three MATH-01 lessons and v2 prompts are user-reported reviewed; MATH-02 compose/decompose prompts were reviewed and approved by the user. Version 11 includes user-reviewed MATH-03/MATH-04 and initial MATH-05 2D-shape/screen-length prompts, plus a draft sphere and unit-cube volume preview with deterministic retry; no saved evidence or backend calls. | Review the new solid/volume prompts; extend mass/time/money measurement and 3D geometry, then build MATH-06. Formal review records are not attached. |
...
5. **EDU-M2 mathematics (PARTIAL; draft only):** Number Garden's three MATH-01 lessons cover count, zero/order and comparison. Optional MATH-02 practice joins and splits groups and adds/takes one; the user approved its prompts. Version 6 added draft MATH-03 equal groups, arrays, and equal sharing. Version 7 added a small MATH-04 preview for tens/ones and fractions. The user reports reviewing MATH-03 and initial MATH-04 prompts. Version 8 added the ten-part decimal/percent preview, which the user reports reviewing. Version 9 added the fraction number-line comparison, now reported reviewed. Version 10 added the 2D-shape and screen-length preview, which the user reports reviewing. Version 11 adds a draft sphere and unit-cube volume preview that needs review. Mass, time, money and further 3D outcomes, plus MATH-06, remain outstanding. Keep the whole activity in draft.
...
- [ ] Review the new MATH-05 solid/volume prompts; extend mass/time/money measures and 3D geometry, then build MATH-06 as a separate tested slice.
