...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden prompts through version 11 are user-reported reviewed; the version 11 sphere and unit-cube volume preview has deterministic retry. No saved learner evidence or backend calls. | Extend mass/time/money measurement and 3D geometry, then build MATH-06. Formal review records are not attached. |
