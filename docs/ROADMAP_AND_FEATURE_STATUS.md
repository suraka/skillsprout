...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden v19 adds quarter-turn orientation, perimeter, model-ruler length, elapsed whole-hour time, equal-unit mass, plus draft chance, equivalent-ratio, and function-rule previews. The user reports reviewing source prompts for Ghana currency and further MATH-05 lessons. No saved learner evidence or backend calls. | New v19 wording/rendering and formal subject/accessibility/device/family review records need review; further MATH-05 geometry/measurement and MATH-06 statistics/probability/ratio/algebra outcomes remain. |
...
Continue by reading this checklist, MASTER_BLUEPRINT.md, FOUNDATIONAL_CURRICULUM.md, EARLY_MATH_DRAFT.md and TEST_PLAN_AND_RESULTS.md. MATH-05 source prompts for Ghana currency and further lessons were reported reviewed and implemented in v18; v19 extends geometry/measurement in bounded samples. MATH-06 has small data, pattern, chance, ratio and algebra samples. New v19 wording/rendering and expert/accessibility/device/family reviews still need evidence. Existing lesson evidence remains untouched; no migration was run.
