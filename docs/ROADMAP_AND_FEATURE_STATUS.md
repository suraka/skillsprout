...
| EDU-M2 / MATH-01…06 | PARTIAL | Number Garden through v18 now includes text-only en-GH cedi coin values, a further unit-cube volume comparison, and a MATH-06 draft path for table reading, chart building, claim checking, pattern extension, and rule description. The user reports reviewing MATH-05 source prompt material. No saved learner evidence or backend calls. | Review new MATH-06 wording; expand remaining MATH-05 geometry, calibrated measurement, time and mass; cover MATH-06 chance/ratio/algebra outcomes in suitable levels. Qualified, assistive-technology, device and family review records are not attached. |
...
5. **EDU-M2 mathematics (PARTIAL; draft only):** Number Garden's three MATH-01 lessons cover count, zero/order and comparison. Optional MATH-02 practice joins and splits groups and adds/takes one; the user approved its prompts. Version 6 added draft MATH-03 equal groups, arrays, and equal sharing. Version 7 added a small MATH-04 preview for tens/ones and fractions. The user reports reviewing MATH-03 and MATH-04 prompts, including decimal/percent and number-line comparison. Version 10 added the 2D-shape and screen-length preview, which the user reports reviewing. The user also reports reviewing version 11's sphere and unit-cube volume preview, plus version 12's exact-hour clock prompt. Version 13 adds a balance comparison, which the user reports reviewing. Version 14 adds a make-believe token-value addition prompt and version 15 adds a pretend-purse point comparison; the user reports reviewing both. Version 18 implements the user-reported reviewed-source Ghana-currency and further MATH-05 prompts as text-only cedi values and another unit-cube volume comparison. Versions 16–18 cover a draft MATH-06 path through table reading, chart building, a claim check, pattern extension, and a symbolic rule. New MATH-06 wording needs review. Other geometry/transformation, calibrated measurement, time/mass, chance, ratio and algebra outcomes remain outstanding. Keep the activity in draft.
...
- [x] Record the user report that the version 12 exact-hour clock prompt was reviewed.
...
- [x] Implement the user-reported reviewed-source MATH-05 Ghana cedi lesson using text-only GH¢2, GH¢1, and 50-pesewa coin values; no cash handling, purchase, or exchange-rate claims. Official value references: [Bank of Ghana Act §37](https://www.bog.gov.gh/wp-content/uploads/2019/09/banking-and-financial-laws-of-ghana-1998-2006.pdf) and [Bank of Ghana coin notice](https://www.bog.gov.gh/wp-content/uploads/2026/07/Notice-No.23-BOG-SEC-GOV-2026-REJECTION-OF-GHANA-CEDI-COINS.pdf).
...
- [ ] Review the new version 18 MATH-06 wording and rendered MATH-05 screens; attach review records.
- [ ] Complete remaining MATH-05 geometry/transformation, calibrated measurement, time and mass outcomes, and older-level MATH-06 chance/ratio/algebra outcomes.
...
- [ ] Expand MATH-05 geometry/transformation and calibrated measurement, time and mass outcomes; add suitable MATH-06 chance/ratio/algebra outcomes.
...
Continue by reading this checklist, MASTER_BLUEPRINT.md, FOUNDATIONAL_CURRICULUM.md, EARLY_MATH_DRAFT.md and TEST_PLAN_AND_RESULTS.md. The MATH-05 source prompts for Ghana currency and further lessons are reported reviewed and now implemented in v18; the exact page rendering has not separately been reviewed. The MATH-06 draft now covers the table/chart/claim/pattern-rule path; new v18 wording needs review. Other early-years and literacy slices retain their own human review gates. Check exact version 18 CI results below. Existing lesson evidence remains untouched; no migration was run.
