...
| EDU-M2 / MATH-01…06 | PARTIAL | Draft Number Garden is grouped into three lessons (count; zero and order; compare), followed by optional add-one/take-one practice; deterministic retry, no saved evidence or backend calls. Product-owner review is satisfied for v2 prompts, choices, English locale, age/ability fit, accessibility and safety. | Qualified specialist confirmation, manual assistive/device/family checks and the remaining number outcomes are still required. |
