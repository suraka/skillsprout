...
**Activity:** `math-number-garden-001`, version 20
**Locale:** English (United States), `en-US`. Money examples use U.S. dollars and cents; measurement examples use U.S. customary units where a named unit is needed.
**Evidence:** guest practice held only in the current page visit; never treated as mastery

## Scope

This draft keeps the original three MATH-01 lessons and optional MATH-02 through MATH-06 previews. MATH-05 now includes 2D shapes and quarter-turn orientation, a unit-grid perimeter, an illustrated ruler in inches, whole-hour elapsed time, equal-unit mass, unit-cube volume, and U.S. dollar/cents prompts. MATH-06 now includes a synthetic table/chart/claim sequence, a repeating pattern rule, qualitative chance, equivalent ratios, and an add-three function table. Version 20's new wording is a draft and needs review. These slices do not complete all MATH-05 or MATH-06 outcomes.
...
| U.S. customary model ruler | Find length from the 1 inch mark to the 5 inch mark. | Illustrated marks; explicitly not a calibrated on-screen ruler. |
...
| U.S. dollar and cents | Match a $1 bill to 100 cents and add a $1 bill plus one 25-cent quarter. | Text-only labels; totals use integer cents; no price or purchase. |
...
- Continue broader MATH-05 geometry, transformation and calibrated measurement outcomes, and suitable MATH-06 statistics, probability, ratio and algebra outcomes as separate reviewed slices. Version 20 is only a small draft sample and does not complete EDU-M2.
...
The user reports reviewing Number Garden prompts through version 19 and source prompts for real-currency and further MATH-05 lessons. Version 20 adapts the money and ruler examples for the U.S. locale. Its new locale-specific wording and rendered screens have not been separately reviewed. Reviewer identities, findings, and formal sign-off records are not attached; the manifest remains draft.
...
MATH-05 money: the current U.S. lesson asks learners to identify a $1 bill as 100 cents, then combine it with one 25-cent quarter to make $1.25. The screen uses text labels only, makes no price or exchange-rate claim, and does not ask a learner to handle cash. Official references: [U.S. Mint Coin Classroom](https://kids.usmint.gov/about-the-mint/dollar) and [U.S. Mint Circulating Coins](https://www.usmint.gov/learn/coins-and-medals/circulating-coins).
...
MATH-05 adds an arrow quarter-turn, 3-by-2 grid perimeter, model ruler in inches with a nonzero starting mark, same-day elapsed whole hours, and mass expressed in identical model units. The labels distinguish drawings and unit models from calibrated real instruments. MATH-06 adds a qualitative likelihood comparison from a fixed pretend bag, a 2:3-to-4:6 equivalent ratio, and an add-three function-table rule. These are short previews for older learners where appropriate; they do not imply mastery or an approved curriculum map. Runtime and browser checks are added, but v20 U.S. money/ruler wording and visual presentation still require human content/accessibility review.

GitHub CI [Frontend checks 35929285089](https://github.com/suraka/skillsprout/actions/runs/35929285089), commit `0710d9520913c555afc025679627e23c260456af`, passed frozen install, TypeScript, all 59 runtime tests, all 38 Chromium browser tests, and production build. The first run found one browser assertion checking a money disclaimer after its screen closed; the assertion was moved to the lesson/completion screens and the follow-up passed. Human review of the v20 U.S. locale wording and rendered screens remains open.
