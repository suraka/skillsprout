...
export function RainbowHabitat() {
  ...
  function restart() { setRoundIndex(0);setMatchColor(false);setPaused(false);setFinished(false);setBloom(false);setFeedback('Ready when you are. Find a home with the same shape and pattern.'); }
